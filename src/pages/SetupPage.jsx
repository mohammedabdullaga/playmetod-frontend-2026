    ...
    <section className="px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl space-y-10">
        <div className="rounded-[32px] border border-[#ffbb00]/15 bg-slate-950/80 p-8 shadow-glow sm:p-10">
          <p className="text-sm uppercase tracking-[0.3em] text-[#ffbb00]/90">{texts.setup.title}</p>
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {texts.setup.cards.map((card) => (
            <Link key={card.title} to={card.path} className="rounded-[28px] border border-[#ffbb00]/15 bg-slate-900/80 p-6 text-left transition hover:-translate-y-1 hover:border-[#ffbb00]/30 hover:bg-slate-800/80">
              <p className="text-sm uppercase tracking-[0.2em] text-[#ffbb00]/90">{card.title}</p>
