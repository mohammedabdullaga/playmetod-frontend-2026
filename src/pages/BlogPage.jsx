function BlogPage({ texts }) {
  return (
    <section className="px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl rounded-[32px] border border-[#ffbb00]/15 bg-slate-950/80 p-10 text-slate-200 shadow-glow">
        <p className="text-sm uppercase tracking-[0.3em] text-[#ffbb00]/90">{texts.blog.title}</p>
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2">
          <div className="rounded-[28px] border border-[#ffbb00]/15 bg-slate-900/80 p-6">
