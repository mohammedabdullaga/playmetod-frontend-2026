function LanguageSwitcher({ lang, onChangeLang, texts }) {
  return (
    <div className="flex items-center gap-2 rounded-full border border-[#cc9a00]/15 bg-white/5 p-1 text-xs text-slate-200 shadow-[0_12px_38px_-10px_rgba(255,255,255,0.12)]">
      <button
