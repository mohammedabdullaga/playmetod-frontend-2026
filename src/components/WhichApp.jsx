  ...
  return (
    <section className="px-4 pb-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl rounded-[32px] border border-[#cc9a00]/15 bg-slate-950/80 p-8 shadow-glow sm:p-10">
        <div className="mb-8">
          <p className="text-sm uppercase tracking-[0.28em] text-[#cc9a00]/90">{texts.whichApp.title}</p>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-[28px] border border-[#cc9a00]/15 bg-slate-900/80 p-6 shadow-lg">
            ...
            <a href={texts.hero.androidLink} target="_blank" rel="noreferrer" className="mt-6 inline-flex rounded-full bg-[#cc9a00] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#b38f00]">
          ...
          <div className="rounded-[28px] border border-[#cc9a00]/15 bg-slate-900/80 p-6 shadow-lg">
            ...
            <a href={texts.hero.wireguardLink} target="_blank" rel="noreferrer" className="mt-6 inline-flex rounded-full border border-[#cc9a00]/15 bg-white/5 px-5 py-3 text-sm font-semibold text-slate-100 transition hover:bg-white/10">
