    ...
    <section className="px-4 pb-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-sm uppercase tracking-[0.3em] text-[#cc9a00]/90">{texts.devices.title}</p>
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {texts.devices.items.map((device) => (
            <div key={device.title} className="rounded-[28px] border border-[#cc9a00]/15 bg-slate-950/80 p-6 shadow-lg transition hover:-translate-y-1 hover:border-[#cc9a00]/30 hover:bg-slate-900/90">
